...
def grabDataYahooFinance(x):
    ...
    def create_tkinter():
        ...
        def calc_moving_averages(x):
            ...
            def plotly_plot_SMA():
                fig = go.Figure()
                fig.add_trace(go.Scatter(x=max_daily_intervals_dates[-90:], y=max_daily_closes[-90:], name='Closes',
                                          line=dict(color='#f3722c', width=4)))
